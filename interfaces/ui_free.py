...
################################################################################
## Form generated from reading UI file 'freeEDgaUl.ui'
##
...
class Ui_frm_free(object):
    def setupUi(self, frm_free):
        if not frm_free.objectName():
            frm_free.setObjectName(u"frm_free")
        frm_free.resize(210, 180)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_free.sizePolicy().hasHeightForWidth())
        frm_free.setSizePolicy(sizePolicy)
        frm_free.setMinimumSize(QSize(210, 180))
        frm_free.setMaximumSize(QSize(210, 180))
        icon = QIcon()
        icon.addFile(u":/icons/resources/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_free.setWindowIcon(icon)
        frm_free.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QWidget(frm_free)
        ...
        self.tbx_fre = QLineEdit(self.frame)
        self.tbx_fre.setObjectName(u"tbx_fre")
        self.tbx_fre.setGeometry(QRect(13, 30, 170, 26))
        self.tbx_fre.setMinimumSize(QSize(170, 0))
        self.tbx_fre.setMaximumSize(QSize(170, 16777215))
        self.tbx_fre.setAlignment(Qt.AlignCenter)
        ...
        frm_free.setCentralWidget(self.centralwidget)
#if QT_CONFIG(shortcut)
        self.lbl_fre.setBuddy(self.lbl_fre)
        self.lbl_sde.setBuddy(self.lbl_sde)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_fre, self.cbx_sde)
        QWidget.setTabOrder(self.cbx_sde, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_free)

        QMetaObject.connectSlotsByName(frm_free)
    # setupUi

    def retranslateUi(self, frm_free):
        frm_free.setWindowTitle(QCoreApplication.translate("frm_free", u"GCode Editor", None))
#if QT_CONFIG(tooltip)
        self.tbx_fre.setToolTip(QCoreApplication.translate("frm_free", u"Digite la l\u00ednea de c\u00f3digo", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.tbx_fre.setStatusTip("")
...
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_free", u"Agregar", None))
#if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(QCoreApplication.translate("frm_free", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
