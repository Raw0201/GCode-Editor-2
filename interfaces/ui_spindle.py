...
################################################################################
## Form generated from reading UI file 'spindlebJwHIq.ui'
##
...
"}")
        ...
        self.cbx_rot.setGeometry(QRect(10, 80, 170, 26))
        self.cbx_rot.setMinimumSize(QSize(170, 26))
        self.cbx_rot.setMaximumSize(QSize(170, 16777215))
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.cbx_rot.setToolTip(QCoreApplication.translate("frm_spindle", u"Seleccione el husillo de trabajo a utilizar", None))
#endif // QT_CONFIG(tooltip)
