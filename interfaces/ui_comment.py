...
"}")
    ...
    def retranslateUi(self, frm_comment):
        ...
        self.lbl_sde.setText(QCoreApplication.translate("frm_comment", u"Lado del programa", None))
#if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(QCoreApplication.translate("frm_comment", u"Seleccione el lado del programa", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
