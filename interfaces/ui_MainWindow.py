...
################################################################################
## Form generated from reading UI file 'MainWindowFYzfle.ui'
##
...
"}")
        ...
        self.menuShow = QMenu(self.menuOptions)
        self.menuShow.setObjectName(u"menuShow")
        self.menuHide = QMenu(self.menuOptions)
        self.menuHide.setObjectName(u"menuHide")
        self.menuModificar = QMenu(self.menubar)
        ...
        self.btn_material = QPushButton(self.groupBox_program)
        self.btn_material.setObjectName(u"btn_material")

        self.gridLayout.addWidget(self.btn_material, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_free, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_comment, 4, 0, 1, 1)

        self.btn_subrutine = QPushButton(self.groupBox_program)
        self.btn_subrutine.setObjectName(u"btn_subrutine")

        self.gridLayout.addWidget(self.btn_subrutine, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_end, 1, 0, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.tabWidget_functions.sizePolicy().hasHeightForWidth())
        self.tabWidget_functions.setSizePolicy(sizePolicy3)
        ...
        QWidget.setTabOrder(self.btn_header, self.btn_material)
        QWidget.setTabOrder(self.btn_material, self.btn_comment)
        ...
        self.menubar.addAction(self.menuModificar.menuAction())
        ...
        self.menuEdit.addAction(self.actionReturn_to)
        self.menuEdit.addSeparator()
        ...
        self.menuOptions.addAction(self.menuHide.menuAction())
        ...
        self.menuModificar.addAction(self.actionBlock)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionBlock.setToolTip(QCoreApplication.translate("MainWindow", u"Bloquear l\u00edneas", None))
        ...
        self.menuOptions.setTitle(QCoreApplication.translate("MainWindow", u"Opciones", None))
...
#endif // QT_CONFIG(statustip)
        self.btn_tool_close.setText(QCoreApplication.translate("MainWindow", u"Cerrar h&erramienta", None))
        self.groupBox_program.setTitle(QCoreApplication.translate("MainWindow", u"Programa", None))
#if QT_CONFIG(tooltip)
        self.btn_material.setToolTip(QCoreApplication.translate("MainWindow", u"Agrega datos del material y la pieza", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_material.setStatusTip(QCoreApplication.translate("MainWindow", u"Agrega datos del material y la pieza", None))
#endif // QT_CONFIG(statustip)
        self.btn_material.setText(QCoreApplication.translate("MainWindow", u"Datos del material", None))
#if QT_CONFIG(tooltip)
        self.btn_free.setToolTip(QCoreApplication.translate("MainWindow", u"Agrega comandos personalizados por el usuario", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.btn_free.setStatusTip(QCoreApplication.translate("MainWindow", u"Agrega comandos personalizados por el usuario", None))
#endif // QT_CONFIG(statustip)
        self.btn_free.setText(QCoreApplication.translate("MainWindow", u"C\u00f3digo &Libre", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(statustip)
        self.btn_subrutine.setText(QCoreApplication.translate("MainWindow", u"Llamar Subrutina", None))
#if QT_CONFIG(tooltip)
